/*
 calendermws_lang.js - Script with multi-language support for generating calender popups
  ...
  Initial (calendarmws.js): November 9, 2003 - Last Revised: November 22, 2006
...
Calendar.prototype.show = function() {
	...
	var yOK=!ggInactive||vNowYear<vDate.getYear()?1:0;
	var mOK=!ggInactive||(yOK||(vNowYear<=vDate.getYear()&&vNowMonth<vDate.getMonth()))?1:0;
...
Calendar.prototype.cal_data = function() {
	...
	var yOK=!ggInactive||vNowYear<=vDate.getYear()?1:0;
	var mOK=!ggInactive||vNowYear<vDate.getYear()||
	 (vNowYear==vDate.getYear()&&vNowMonth<=vDate.getMonth())?1:0;
	var ymOK=yOK&&mOK?1:0;
	var dOK=!ggInactive||vNowYear<vDate.getYear()||vNowMonth<vDate.getMonth()?1:0;
