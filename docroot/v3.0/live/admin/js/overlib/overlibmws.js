...
if(OLud('cgcolor'))var ol_cgcolor="#333333";
...
if(OLud('textsize'))var ol_textsize='10px';
if(OLud('captionsize'))var ol_captionsize='10px';
...
if(OLud('delay'))var ol_delay=500;
...
function overlib()
{
	...
	if (OLexclusivePI && o3_exclusive && o3_exclusivestatus != "") {
		...
		if (o3_autostatus == 2 && o3_cap != "") {
			o3_status = o3_cap;
		}
		else {
			if (o3_autostatus == 1 && o3_text != "")o3_status = o3_text;
		}
	}
	if (!o3_delay) {
		return OLmain();
