/*
 overlibmws_overtwo.js plug-in module - Copyright Foteos Macrides 2003-2006
   ...
   Initial: July 14, 2003 - Last Revised: November 19, 2006
...
if(OLtimerid>0){clearTimeout(OLtimerid);OLtimerid=0;}
if(OLshowid>0){clearTimeout(OLshowid);OLshowid=0;}
if(OLp1over&&OLp1over!=OLmkLyr()){OLp1over=null;over2=null;return;}
...
OLp1over=over;over=over2;if(OLmodalPI)OLchkModal();if(OLbubblePI)OLbubbleHt=0;
