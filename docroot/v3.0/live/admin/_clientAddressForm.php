<?php
function clientAddressForm($fieldName, $data)
{
	...
	<input type="hidden" name="<?php echo $fieldName ?>[id]" value="<?php echo $model ? $data['id'] : 0 ?>" id="<?php echo $fieldName ?>_addressId">
	...
	AddressTools('<?php echo $fieldName ?>').init();
	</script>
