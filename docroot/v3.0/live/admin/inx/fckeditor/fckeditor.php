<?php 
require_once("inx/general.inc.php");
/*
...
class FCKeditor
{
	...
	function FCKeditor( $instanceName,$Value=NULL,$attributes=array() )
	{
		$this->InstanceName	= $instanceName ;
		$this->BasePath		= GLOBAL_URL.'inx/fckeditor/';
		$this->Width		= $attributes["width"]; //'450px' ;
		$this->Height		= $attributes["height"]; //'300px' ;
		$this->ToolbarSet	= 'Test' ;
		$this->Value		= $Value ;
