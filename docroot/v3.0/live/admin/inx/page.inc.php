...
class HTML_Page2 extends HTML_Common {
     ...
     * @since   2.0
     */
    var $_metaTags = array( 'standard' => array ( ) );
    ...
    function HTML_Page2($attributes = array())
    {
        ...
        $this->addFavicon(GLOBAL_URL.'favicon.ico');
    ...
    function _generateHead()
    {
        ...
        $strHtml .= $tab . '<title>' . $this->getTitle() . ' - '.SYSTEM_VERSION.'</title>' . $lnEnd;
    ...
    function toHtml()
    {
		...
		$xstrHtml .= '<script language="JavaScript1.2">
// stops text being selected
