...
while ($row = $q->fetchRow()) {
	...
	$data[] = '
		...
		<a href="new_client_questionaire_sales.php?cli_id='.$row["cli_id"].'"><img src="/images/sys/admin/icons/edit-icon.png" border="0" width="16" height="16" hspace="1" alt="View/Edit this client" /></a>
