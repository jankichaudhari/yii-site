<?php
define("FEED_NAME", "thinkproperty");
require_once(dirname(__FILE__) . "/../../../../../config/config_feed.inc.php");
$strFolderName = date('Ymd');
$strPath       = dirname(__FILE__) . '/thinkproperty/' . $strFolderName;
...
//$ftp_server   = "ftp.thinkproperty.com";
//$ftp_username = "TPMarkdw";
//$ftp_password = "TPMarkdw";
