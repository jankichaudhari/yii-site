...
$strPath = '/home/woosterstock/htdocs/v3.0/live/admin/feed/rightmove_lettings/'.$strFolderName;
...
// overwrite with single branch ID
$intRMBranchID = 40674;
...
$ftp_server = "ftp.lettingsearch.co.uk";
$ftp_username = "woos.lettingsearch.co.uk";
$ftp_password = "wooster";
...
// completion email
if ($error_msg) {
	mail('mail@markdw.com','feed notify',"feed notify for $strPath\n\n$error_msg");
	}
?>