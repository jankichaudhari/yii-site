	<?php
define("FEED_NAME", "nethouseprices");
require_once(dirname(__FILE__) . "/../../../../../config/config_feed.inc.php");
$strFolderName = date('Ymd');
$strPath       = dirname(__FILE__) . '/nethouseprices/' . $strFolderName;
...
WHERE
(deal.dea_status = 'Available' OR deal.dea_status = 'Under Offer' OR deal.dea_status = 'Under Offer with Other') AND dea_branch != 5
...
//	if ($row["dea_branch"] == 1) { // cam.sale
//		$intRMBranchID = 'F4892E00D92377';
//	}
//	elseif ($row["dea_branch"] == 2) { // syd.sale
//		$intRMBranchID = 'F4892E1541BA95';
//	}
//	elseif ($row["dea_branch"] == 3) { // cam.let
//		$intRMBranchID = 'F4892E0CE487AD';
//	}
//	elseif ($row["dea_branch"] == 4) { // syd.let
//		$intRMBranchID = 'F4892E1F67F541';
//	}
...
//$ftp_server   = "ftp.nethouseprices.com";
//$ftp_username = "S43EB21D3C8911";
//$ftp_password = "brUCH4sw";
