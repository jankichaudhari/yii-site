<?php
define("FEED_NAME", "ezylet_cam");
require_once(dirname(__FILE__) . "/../../../../../config/config_feed.inc.php");
$strFolderName = date('Ymd');
$strPath       = dirname(__FILE__) . '/ezylet_cam/' . $strFolderName;
// name of textfile (date.blm)
$strTextFile = 'WOST0' . date('Ymd') . "01.blm";
...
// 2 epc
// 5 floorplans
	$image_path = dirname(__FILE__) . '/' . $row["dea_id"] . '/';
...
//$ftp_server   = "ftp.ezylet.com";
//$ftp_username = "woosterandstock";
//$ftp_password = "aD8.v-fG";
$dstr_dir = "/";
