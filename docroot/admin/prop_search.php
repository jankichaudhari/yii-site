...
if ($_GET["action"] == "Search") {
	...
	$sql         = "SELECT * FROM property, area, state_of_trade, proptype, leasefree, branch WHERE property.SaleLet = 1 AND ";
...
// added 02/11/05
	...
	$sql .= " AND property.type_id = proptype.type_ID AND property.lease_free = leasefree.id_LeaseFree ";
...
// Prev  and Next buttons
		if ($from) {
			$prev = "<a href=\"$strPageLink&from=" . $data['prev'] . "\">&lt Prev Page</a>";
		}
		if ($data['next']) {
			$next = "<a href=\"$strPageLink&from=" . $data['next'] . "\">Next Page &gt</a>";
		}
...
// start of table
        ...
        <table border="0" cellspacing="2" cellpadding="2" width="700">
		  <tr>
		    <td><a href="prop_search.php">New Search</a> - ' . $data['numrows'] . ' records found</td>
...
<table width="650" border="0" cellpadding="5" cellspacing="3">
	<tr>
		<td class="pageTitle">Sales Property Search</td>
		<td align="right"><a href="index.php">Main Menu</a></td>
	</tr>
</table>
