...
<form method="post" enctype="multipart/form-data" name="form">
  ...
  <input type="hidden" name="searchLink" value="<?php echo $searchLink; ?>">
	...
	<table width="600" align="center" cellpadding="4" cellspacing="3">
	  <tr>
		...
		<td align="right" class="anchorNav"><a href="print.php?propID=<?php echo $intPropID; ?>">Print</a></td>
      </tr>
	<?php
	if ($_GET["changes"]) {
	?>
  ...
  <table align="center" width="600" border="0" cellspacing="3" cellpadding="4">
    ...
    <tr>
      ...
      <td width="200" align="left" class="greyForm"><input name="Price" type="text" style="width: 80px;" onKeypress="if (event.keyCode < 48 || event.keyCode > 58) event.returnValue = false;" value="<?php echo $intPrice; ?>" size="8" maxlength="8"></td>
    ...
    <tr>
      ...
      <td class="greyForm"><input name="Price2" type="text" style="width: 80px;" onKeypress="if (event.keyCode < 48 || event.keyCode > 58) event.returnValue = false;" value="<?php echo $intPrice2; ?>" size="8" maxlength="8">
...
<table align="center" width="600" border="0" cellspacing="3" cellpadding="4">
  ...
  elseif ($view == "log") {
  $sqlLog = "SELECT *, date_format(changelog.cha_datetime, '%d/%m/%y %h:%m:%s') as cha_date FROM changelog, admin WHERE changelog.cha_user = admin.adm_id AND changelog.cha_table = 'property' AND changelog.cha_row = $intPropID ORDER BY changelog.cha_datetime DESC";
