...
' . $viewings_table . '
			...
			$formName = 'form1';
			$form->addHtml("<fieldset>\n");
			$form->addLegend('Property to View');
			...
			if ($numApps) {
				$form->addHtml("<fieldset>\n");
				$form->addLegend('Viewing History');
...
ORDER BY $orderby $direction";
		...
		<a href="deal_summary.php?dea_id=' . $row["dea_id"] . '&searchLink=' . $searchLink . '"><img src="' . GLOBAL_URL . 'img/icons/page_edit.gif" border="0" width="16" height="16" hspace="1" alt="View/Edit this property" /></a>
		<a href="javascript:dealPrint(\'' . $row["dea_id"] . '\');"><img src="' . GLOBAL_URL . 'img/icons/printer.gif" border="0" width="16" height="16" hspace="1" alt="Print this property" /></a>
		</td>
		</tr>';
					/*
					$data[] = '
