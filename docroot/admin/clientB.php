...
elseif ($_POST["action"] == "Insert") {
	...
	BedroomsLet,MinPriceLet,MaxPriceLet,FurnishedLet,TermLet,StatusLet,Lettings,Sales,Branch)
	VALUES
	('$Password','$Email','$Email2','$Name','$Salutation','$Address1','$Address2','$Address3','$City','$Country',
	'$Postcode','$Tel','$Fax','$Mobile','$PropertyType','$MinPrice','$MaxPrice','$Receptions','$Bedrooms',
	...
	'$BedroomsLet','$MinPriceLet','$MaxPriceLet','$FurnishedLet','$TermLet','$StatusLet','$Lettings','$Sales','$selected_branches')
	";
...
<form method="post" enctype="multipart/form-data" name="form" onSubmit="return ValidateClientForm();">
  ...
  <table border="0" width="600" align="center" cellpadding="5" cellspacing="0">
    <tr>
      <td><strong>Initial contact by phone?</strong> <br>
        Yes
        <input type="radio" name="contacted" value="Y">
        No
        <input type="radio" name="contacted" value="N"> </td>
      <td align="right" valign="middle">Notes:</td>
      <td align="left" valign="middle"> <textarea name="Areas2" rows="4" wrap="VIRTUAL" style="width: 300px"><?php echo $Areas2; ?></textarea></td>
      <td align="right" valign="middle"><input type="submit" name="Submit" value="Save"></td>
    </tr>
  </table>
  ...
  <table border="0" width="600" align="center" cellpadding="0" cellspacing="0">
    <tr align="center">
      <td height="30" colspan="2">Selected branches: <strong><?php echo $RenderBranch; ?></strong></td>
    </tr>
    <tr>
      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="3" cellpadding="4">
          ...
          <tr>
            ...
            <td class="greyForm"><input type="text" name="Password" value="<?php echo $Password; ?>" style="width: 100px">
              <input type="button" name="Button" value="Send p/w" style="width: 70px"> </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="greyForm"><select name="Selling" style="width: 180px">
                <?php echo db_enum("clients","Selling",$Selling); ?> </select></td>
          </tr>
          <tr>
      ...
      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="3" cellpadding="4">
          ...
          <tr>
            ...
            <td class="redForm"><label for="StatusYes">
              ...
              Yes</label> &nbsp;&nbsp; <label for="StatusNo">
              <input type="radio" name="Status" id="StatusNo" value="S" <?php if ($Status == "S") { echo "checked"; } ?>>
              No</label></td>
          </tr>
        </table>
        <br> <table width="100%" border="0" cellspacing="3" cellpadding="4">
          <tr align="center">
          ...
          <tr>
            ...
            <td class="greyForm"><select name="TermLet" style="width:120px">
                <?php echo db_enum("clients","TermLet",$TermLet); ?> </select></td>
          </tr>
          <tr>
            <td height="30" align="right" class="redForm">Email Updates</td>
    ...
    <tr align="center">
      <td colspan="2"><hr size="1" noshade> <input name="Submit" type="submit" value="   <?php echo $action; ?> Client   ">
    ...
    <tr align="center">
      <td colspan="2"><hr size="1" noshade> <input name="submit" type="submit" value="    Update Record    ">
        <br> <hr size="1" noshade></td>
    </tr>
    <tr align="center">
      <td colspan="2">&nbsp;</td>
