...
/**
 *
 * This data provider is based on the item count on eevery page rather that expected pageSize
 *
 *
 ...
 */
class DataProviderIterator extends CComponent implements Iterator, Countable
{
