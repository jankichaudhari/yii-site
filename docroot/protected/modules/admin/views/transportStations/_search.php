...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'createdDt'); ?>
		<?php echo $form->textField($model,'createdDt'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'modifiedDt'); ?>
		<?php echo $form->textField($model,'modifiedDt'); ?>
	</div>
