...
<div id="main_menu">
	<ul>
        ...
        <li><a href="<?= Yii::app()->params['globalUrlOld']; ?>calendar.php">Calendar</a>
			<ul>
<!--				<li><a href="--><?php //echo Yii::app()->params['globalUrlOld']; ?><!--viewing_add.php">Arrange Viewing</a></li>-->
...
<!--				<li>--><?php //echo CHtml::link("Book appointment", array("Appointment/Create")); ?><!--</li>-->
			</ul>
		</li>
        <li><a href="<?= Yii::app()->params['globalUrlOld']; ?>property.php">Property</a>
			<ul>
				...
				<li><?= CHtml::link('Search Instruction (new)', ['instruction/search', AdminFilterForm::generateResetParam('instruction-filter-form') => 'true']) ?></li>
		...
		<li><a href="#">Clients</a>
			<ul>
                ...
                <!--				<li><a href="--><?php //echo Yii::app()->params['globalUrlOld']; ?><!--applicant_add.php">New Applicant</a></li>-->
